...
void detKeypoints1()
{
    ...
    vector<cv::KeyPoint> keyFASTlist;
    cv::Mat FASTimage = img.clone();
    cv::FAST(imgGray, keyFASTlist, 30, true);
    cv::drawKeypoints(img,keyFASTlist,FASTimage, cv::Scalar::all(-1), cv::DrawMatchesFlags::DRAW_RICH_KEYPOINTS);
